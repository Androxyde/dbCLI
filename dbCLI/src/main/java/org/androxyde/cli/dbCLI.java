...
import org.androxyde.cli.os.CommandOS;
...
@Introspected
@Singleton
@Command(name = "dbCLI", description = "Oracle CLI", mixinStandardHelpOptions = true,
        subcommands = { CommandInventory.class, CommandOS.class }
)
